...
use AdminBundle\Form\ContactusType;
...
class ContactusController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $contactuses = $em->getRepository('AdminBundle:Contactus')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('AdminBundle\Form\ContactusType', $contactus);
    ...
    {
        $deleteForm = $this->createDeleteForm($contactus);
        $editForm = $this->createForm('AdminBundle\Form\ContactusType', $contactus);
